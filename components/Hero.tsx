    ...
    >
      ...
      <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 w-full h-full pointer-events-none">
            <iframe 
                className="w-full h-full object-cover opacity-50 scale-[1.35]"
                src="https://www.youtube.com/embed/trkVjV06KLo?autoplay=1&mute=1&controls=0&loop=1&playlist=trkVjV06KLo&playsinline=1&showinfo=0&rel=0&iv_load_policy=3&disablekb=1" 
                title="Intro" 
                frameBorder="0" 
